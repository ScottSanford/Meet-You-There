        ...
        return {
            ...
            link: function (scope, element, attrs, controllers) {
                ...
                var template = [
                    ...
                    '<ion-item collection-repeat="item in viewModel.searchItems" collection-item-height="52" item-width="100%" ng-click="viewModel.selectItem(item)" class="item-text-wrap">',
